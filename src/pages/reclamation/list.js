              ...
              <Table className={classes.table} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="right">Réponce</StyledTableCell>
                  ...
                  {list &&
                    list
                      .filter((row) => {
                        if (searchTerm == "") {
                          return list;
                        } else if (row.sujet.includes(searchTerm)) {
                          return row;
                        }
                      })
                      .slice(
                              ...
                              onClick={async (event) => {
                                try {
                                  let response = await fetch(
                                    `http://localhost:5000/api/reclamation/${row._id}`,
                                    {
                                      method: "DELETE",
                                      headers: {
                                  ...
                                  setsuccess("Réclamation bien suprimer");
                                } catch (err) {
                                  console.log(err);
